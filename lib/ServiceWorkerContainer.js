...
module.exports = class ServiceWorkerContainer {
  ...
  _load (scriptURL, fetch) {
    ...
    const globalScope = new ServiceWorkerGlobalScope(this._registration, fetch, this._clientPostMessage.bind(this));
    ...
    this._sw = new ServiceWorker(contextpath, this._swPostMessage.bind(this));
